...
function textAreaAdjust() {
    el_2 = document.querySelector('textarea[name="desc"]');
    el_1= document.querySelector('textarea[name="recipe"]');
    el_1.style.height = "1px";
    el_1.style.height = (10+el_1.scrollHeight)+"px";
    el_2.style.height = "1px";
    el_2.style.height = (10+el_2.scrollHeight)+"px";
  }
